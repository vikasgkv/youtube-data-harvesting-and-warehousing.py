...
Harvesting YouTube data and warehousing it involves interacting with the YouTube API to fetch relevant information like comments,views count,likes count etc and storing it in a database . Here, I am using Python and the google-api-python-client library for interacting with the YouTube API.
